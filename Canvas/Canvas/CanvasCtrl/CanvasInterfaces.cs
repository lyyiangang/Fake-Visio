...
namespace Canvas
{
	...
	public interface ICanvas
	{
        ...
        void DrawRectangle(ICanvas canvas, Pen pen, UnitPoint ptTopLeft, float width, float height);
        void FillRectangle(ICanvas canvas, Brush brush, UnitPoint ptTopLeft, float width, float height);
        void DrawEllipse(ICanvas canvas, Pen pen, UnitPoint ptTopLeft, float width, float height);
        void FillEllipse(ICanvas canvas, Brush brush, UnitPoint ptTopLeft, float width, float height);
        void DrawString(ICanvas canvas, string str, Font font, Brush brush, RectangleF rect, StringFormat format);
    }
